.class public abstract Landroidx/compose/ui/text/android/f;
...
.method public static a(Ljava/lang/CharSequence;Landroid/text/TextPaint;IILandroid/text/TextDirectionHeuristic;Landroid/text/Layout$Alignment;ILandroid/text/TextUtils$TruncateAt;IIZIIII)Landroid/text/StaticLayout;
    ...
    .line 25
    invoke-static {}, Landroidx/activity/q;->b()Landroid/graphics/text/LineBreakConfig$Builder;

    move-result-object p2

    .line 26
    invoke-static {p2, p12}, Landroidx/activity/q;->c(Landroid/graphics/text/LineBreakConfig$Builder;I)Landroid/graphics/text/LineBreakConfig$Builder;

    move-result-object p2

    .line 27
    invoke-static {p2, p13}, Landroidx/activity/q;->B(Landroid/graphics/text/LineBreakConfig$Builder;I)Landroid/graphics/text/LineBreakConfig$Builder;

    move-result-object p2

    .line 28
    invoke-static {p2}, Landroidx/activity/q;->d(Landroid/graphics/text/LineBreakConfig$Builder;)Landroid/graphics/text/LineBreakConfig;

    move-result-object p2

    .line 29
    invoke-static {p0, p2}, Landroidx/activity/q;->t(Landroid/text/StaticLayout$Builder;Landroid/graphics/text/LineBreakConfig;)V
    ...
    .line 30
    invoke-static {p0}, Landroidx/compose/ui/text/android/e;->f(Landroid/text/StaticLayout$Builder;)V
...
.method public static final b(Landroid/text/TextPaint;Ljava/lang/CharSequence;II)Landroid/graphics/Rect;
    ...
    .line 83
    .line 84
    invoke-static {v9, v1, v2, v10, v8}, Landroidx/compose/ui/platform/s0;->q(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V
    ...
    .line 137
    .line 138
    invoke-static {v0, v1, v2, v3, v4}, Landroidx/compose/ui/platform/s0;->q(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Rect;)V
